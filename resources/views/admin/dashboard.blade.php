    ...
    <div class="container mx-auto px-6">
        ...
        <div class="flex justify-between items-center mb-10">
            ...
            <div class="flex gap-4">
                ...
                <button class="bg-gray-800 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition border border-gray-700">Manage Rooms</button>
                <button class="bg-gray-800 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition border border-gray-700">Manage Bookings</button>
            </div>
        </div>
            ...
            <div class="bg-gray-800 p-6 rounded-xl border border-gray-700 shadow-lg">
                <div class="flex justify-between items-start mb-4">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-white">Rp {{ number_format($stats['revenue'], 0, ',', '.') }}</h3>
                    </div>
                ...
                <table class="w-full text-left text-gray-400">
                    ...
                    <tbody class="divide-y divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-700/30 transition">
                            ...
                            <td class="px-6 py-4">{{ \Carbon\Carbon::parse($booking->check_in)->format('d M Y') }}</td>
                            <td class="px-6 py-4">{{ \Carbon\Carbon::parse($booking->check_out)->format('d M Y') }}</td>
                            <td class="px-6 py-4 text-amber-500 font-bold">Rp {{ number_format($booking->total_price, 0, ',', '.') }}</td>
                            <td class="px-6 py-4">
                                <span class="px-2 py-1 bg-green-500/10 text-green-500 rounded text-xs">Confirmed</span>
                            </td>
                        </tr>
                        @empty
                        <tr>
