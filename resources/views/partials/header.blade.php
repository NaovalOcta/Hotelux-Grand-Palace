        ...
        <div class="hidden md:flex items-center space-x-8">
            ...
            @auth
                ...
                <div class="relative group">
                    ...
                    {{-- Dropdown Menu --}}
                    <div
                        class="absolute right-0 mt-2 w-48 bg-gray-800 rounded-lg shadow-xl border border-gray-700 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition duration-200 transform z-50">
